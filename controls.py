...
def loading(screen, stats):
	...
	# Подсказки	
	hints = ["Здоровье восполняется каждые 1000 очков.","Собирайте кристаллы и покупайте улучшения в магазине.",
    "Для пополнения боезапаса зайдите в магазин.","В магазине можно выбирать скины.","Выполняйте цели и получайте новые награды.",
    "Следите за патронами: если они закончатся — вы проиграете.","Кометы бывают разного размера и наносят разное количество урона.",
    "О создании игры можно узнать во вкладке 'Автор'.","Уничтожайте кометы и собирайте бонусные предметы.",
    "Чем дольше вы выживаете, тем больше зарабатываете денег.",
    "Индикатор жизни: при жизни < 60 — оранжевый цвет, при жизни < 30 — красный. Будьте осторожны!"]
